			...
			.findUnique({
				...
				select: {
					...
					comments: {
						...
						select: { ...COMMENT_SELECT_FIELDS, _count: { select: { likes: true } } },
					},
				},
			})
			.then(async (post) => {
...
app.put('/posts/:postId/comments/:commentId', async (req, res) => {
	...
	return await commitToDb(
		prisma.comment.update({ where: { id: req.params.commentId }, data: { message: req.body.message }, select: { message: true } })
	);
});
...
app.delete('/posts/:postId/comments/:commentId', async (req, res) => {
	...
	return await commitToDb(prisma.comment.delete({ where: { id: req.params.commentId }, select: { id: true } }));
});
